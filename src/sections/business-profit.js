...
const data = {
  title:
    'We help you to plan faster with step-by-step guidance',
  description:
    'We asks you questions about your business, you fill in the answers, then we do what we do best. It\'s really that simple. You even have the option to browse our library of sample business plans to find one that matches your business and/or industry.',
    points: [
      {
