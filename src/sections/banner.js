      ...
      <Container sx={styles.banner.container}>
        <Box sx={styles.banner.contentBox}>
          <Heading as="h1" variant="heroPrimary">
            A Creative way to grow and excite your Business Plan
          </Heading>
          <Text as="p" variant="heroSecondary">
            Creative helps you think through every aspect of your business — so you're twice as likely to succeed in planning, funding and growing
          </Text>
          <Subscribe />
