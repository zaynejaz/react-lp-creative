        ...
        <Box sx={styles.footer.footerTopArea}>
          <Box sx={styles.copyrightArea}>
            ...
            <nav className="footer__menu">
              ...
              Business planning, cash forecasting, and financial performance tracking for small businesses and startups.
            </nav>
...
const styles = {
  ...
  copyrightArea: {
    ...
    '.footer__menu': {
      ...
      flexWrap: 'wrap',
      mt: [3, 3, 3, 3, 4],
      mr: ['auto', 'auto', 'auto', 'auto', 4],
      mb: [3, 3, 3, 3, 4],
      ml: ['auto', 'auto', 'auto', 'auto', null],
      maxWidth: ['100%', '100%', '80%', '70%', '100%'],
      a: {
        fontSize: ['14px', 1],
        color: 'text_secondary',
        fontWeight: 'body',
